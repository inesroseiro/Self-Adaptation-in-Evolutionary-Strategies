...
if __name__ == '__main__':
    ...
    for i in range(len(test_data)):
        ...
        if(type_cross == 'h_crossover'):
            #run_for_file(seeds,filename,number_runs,number_of_generations,pop_size,domain,prob_mutation, sigma,prob_crossover,tournament_selection,h_crossover(alpha,domain),muta_float_gaussian,sel_survivors_elite(elite_percentage),fitness_func,test_id)
